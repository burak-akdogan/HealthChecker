<template>
  <div class="py-5 border-top " style="background: #171717 ;">
    <div class="container-lg p-responsive d-flex">
      ...
      <div>
        <a href="https://www.facebook.com/WHO/"><i class="fab fa-facebook fa-xl pr-2"></i></a>
        <a href="https://twitter.com/WHO"><i class="fab fa-twitter fa-xl pr-2"></i></a>
        <a href="https://covid19responsefund.org/en/"><i class="fas fa-donate fa-xl pr-2"></i></a>
      </div>
